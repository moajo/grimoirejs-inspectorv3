import { CHANNEL_NOTIFY_TAB_ID, CHANNEL_CONNECTION_ESTABLISHED, CONNECTION_BG_TO_DEV } from '../common/Constants';
...
export async function connectToBackground<T extends IConnection>(gateway: IGateway<T>, tabId: number) {
  ...
  await postAndWaitReply(connection, CHANNEL_NOTIFY_TAB_ID, tabId, CHANNEL_CONNECTION_ESTABLISHED);
